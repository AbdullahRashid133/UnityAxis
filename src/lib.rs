...
#[derive(Debug)]
pub struct UnityAxisProcessor {
    verbose: bool,
    processed_count: usize,
}

impl UnityAxisProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting UnityAxis processing");
    
    let mut processor = UnityAxisProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = UnityAxisProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = UnityAxisProcessor::new(false);
